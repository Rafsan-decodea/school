  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"> <?php echo $_SESSION["name"] ?>  As  Admin</a>
        </div>
      </div>
   ...
   <!-- This is A Section For Student   -->
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/school/login/dashboard/users/admin/stu/seestudent.php" class="nav-link <?php echo $current_page == 'seestudent.php' ? 'active' : null ?> " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"> <?php echo $_SESSION["name"] ?>  As  Teachers</a>
        </div>
      </div>
